      ...
      steps {
        script {
          sh '''
            ...
            tags="{cir_app_id = \\"grdapi\\", cir_dataclass = \\"sensitive\\", Integration-Env = \\"${ENVIRONMENT_DEPLOY}\\", Integration-Version = \\"v1\\", Integration-Branch = \\"${BRANCH_NAME}\\", Integration-User = \\"${BUILD_USER}\\", Integration-Repository = \\"https://bitbucket.org/nsw-education/loggingservice-splunklogforwarder\\"}"
